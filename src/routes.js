...
const communication = React.lazy(()=>import('./App/containers/Communication/communication'))
...
const profile = React.lazy(()=>import('./App/containers/Settings/profile/index'))
...
const routes = [
    ...
    { path: '/manage/activity', exact: true, name: 'Activity', component: Activity},
    { path: '/manage/billing', exact: true, name: 'Billing', component: Billing},
    { path: '/manage/communication', exact: true, name: 'Comminication', component: communication},
