    ...
    <>
        <div className='form-width'>
            <div className="form-header-container mb-4">
                <h3 className="form-header-text">Profile</h3>
            </div>
            <Card className="mb-4">
                <Form className="form-details">

                <div className="mb-5" style={{ "height": "150px", "width": "150px", "margin": "auto", "margin-bottom": "30px", "text-align": "center"}}>
                    <img src="https://cdn.pixabay.com/photo/2020/07/01/12/58/icon-5359553_960_720.png" style={{ "width": "150px","border-radius": "50%",}}/>
                    <button type="button" class="btn btn-link">Edit Picture</button>
                </div>
                ...
                <Form.Row>
                    ...
                    <br />
                    <Button >Save New Information</Button>
                </Form>
            </Card>
        </div>          
    </>
