            ...
            <div className="bg-light l-wrapper p-3 p-md-5 shadow">
              ...
              <form id="registrationForm">
                <div className="row">
                  ...
                  <div className="form-group">
                  <select id="country" name="countryOfPractice" required="required"
                  onChange={handleChange} value={state['countryOfPractice']}>
                  ...
                  <div className="col-md-12 pt-3">
                  <div className="form-group">
                      <input value={state['emailAddress']}
