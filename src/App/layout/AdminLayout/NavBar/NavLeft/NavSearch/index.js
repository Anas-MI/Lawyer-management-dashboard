    ...
    render() {
        ...
        return (
            ...
            <Aux>
                ...
                <AutoComplete value={this.searchValue} onChange={this.onSearch} options={[{label:'Dashboard',value:'/admin/dashboard'},{label:'Lawyers',value:'/lawyers'},{label:'Profile',value:'/profile'}]}
